  ...
  return( 
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
      <div className="bg-gray-300 p-4 m-4 rounded">
        <h2 className="text-center font-bold text-2xl">Website Developer</h2>
      ...
      <div className="bg-gray-100 p-4 m-4 rounded">
        <img src="https://res.cloudinary.com/doabbpdy1/image/upload/v1752228340/laptopweb_ef7c42.jpg" alt="" />
      </div>
    </div>
